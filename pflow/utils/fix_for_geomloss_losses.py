...
from pflow.utils.fix_for_geomloss_samples import sinkhorn_tensorized
...
class SamplesLoss(Module):
    ...
    def __init__(self, loss="sinkhorn", p=2, blur=.05, reach=None, diameter=None, scaling=.5, truncate=5, cost=None,
                 kernel=None, cluster_scale=None, debias=True, potentials=False, verbose=False, backend="auto", **kwargs):
